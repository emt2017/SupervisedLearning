...
%load data
load Mini_project#1/featureMat_Gelatine_test_bioLBP.mat
load Mini_project#1/featureMat_Gelatine_train_bioLBP.mat
...
train_fake_features = featureMat_Gelatine_train_bioLBP;
...
%Train Naive Bayes classifier --- Gelatine
model = fitcnb(train', labels');

%-------------------TEST--------------------------------------

%test data
test_live_features = featureMat_liv_test_bioLBP;
test_fake_features = featureMat_Gelatine_test_bioLBP;
